...
import com.oneui.fontviewer.fragment.trash.data.TrashRepository;   // ★ جديد ★
import com.oneui.fontviewer.dialog.TrashActionDialogs;          // ★ إصلاح (1)(3): إدارة الإشعارات والخدمة ★
...
import com.oneui.fontviewer.utils.notification.OperationForegroundService;   // ★ إصلاح (1)(3): الدرع الواقي ★
