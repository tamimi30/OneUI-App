...
public class NavManager {
    ...
    public void handleFontSelected(String fontPath, String realName, String fileName,
        ...
        // ★ حل مشكلة الـ 3 ضغطات: لا نُضيف الشاشة للمكدس إذا كانت هي عارض الخطوط نفسه
        // (يحدث هذا عند فتح خط من متصفح ملفات خارجي) لمنع الحاجة لضغطة رجوع إضافية.
        if (sourceScreen != AppScreen.FONT_VIEWER) {
